...
namespace Mhotivo.Authorizations
{
    ...
    public class AuthorizeAdminDirector : AuthorizeAttribute
    {
        private static readonly List<string> RequireAtLeastOnePrivileges = new List<string>{"Administrador","Director"};
